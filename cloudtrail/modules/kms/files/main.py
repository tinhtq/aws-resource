...
def lambda_handler(event, context):
    ...
    match eventName:
        case "CreateTags":
            print("Create Tags")        
        case _:
            attach_tags(event['detail']['responseElements']['keyMetadata'][resourceId], event['detail']['responseElements']['keyMetadata'], username)
    return {
        'statusCode': 200,
...
def attach_tags(resource_id, responseElements, username):
    ...
    kms.tag_resource(KeyId=resource_id, Tags=tags)